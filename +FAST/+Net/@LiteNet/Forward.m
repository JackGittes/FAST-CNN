    ...
    for i=1:length(op_parse)
        ...
        switch op_parse(i).opcode_index
            case 1
                ...
                shift = shift_list(i+1); 
                bias_sft = shift_list(i);
                ...
                net = nn.LiteConv2d(net,conv_w_tf,z_im,z_ker,z_res,s1,s2,s3,'Conv2d',stride,padding,bias_w_tf,shift,bias_sft);
            ...
            case 2
                ...
                net = nn.LiteConv2d(net,conv_w_tf,z_im,z_ker,z_res,s1,s2,s3,'DepthwiseConv2d',stride,padding,bias_w_tf,shift,bias_sft);
            case 3
